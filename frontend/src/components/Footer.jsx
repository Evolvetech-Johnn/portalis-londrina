        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-obsidian-800 flex items-center justify-center text-slate-400 hover:bg-gold-600/20 hover:text-gold-400 transition-colors font-medium text-xs" aria-label="Instagram">
                IG
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-obsidian-800 flex items-center justify-center text-slate-400 hover:bg-gold-600/20 hover:text-gold-400 transition-colors font-medium text-xs" aria-label="LinkedIn">
                IN
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-slate-400 hover:text-gold-300 text-sm">Sobre nós</Link></li>
              <li><ScrollToFormLink className="text-slate-400 hover:text-gold-300 text-sm">Diagnóstico</ScrollToFormLink></li>
              <li><Link to="/" className="text-slate-400 hover:text-gold-300 text-sm">Cases de Sucesso</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/termos" className="text-slate-400 hover:text-gold-300 text-sm">Termos de Uso</Link></li>
              <li><Link to="/privacidade" className="text-slate-400 hover:text-gold-300 text-sm">Política de Privacidade</Link></li>
            </ul>
          </div>
